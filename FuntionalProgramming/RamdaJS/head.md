...
> See also [tail](./tail.md), [init](./lint.md), [last](./last.md).

## 설명

- 배열의 첫 번째 원소 또는 유사 배열인 문자열의 첫 번째 원소인 첫 번째 문자를 반환한다.
- 배열의 경우 첫 번째 원소가 없는 경우 `undefined`가 반환되며, 문자열의 경우 빈 문자열을 반환한다.
...
- https://github.com/ramda/types/blob/develop/types/head.d.ts
